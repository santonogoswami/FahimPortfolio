...
<div class="container">
    <h2>-----</h2>
    <form action="{{route('backend.effect.update', $data->id)}}" method="post" enctype="multipart/form-data">
        @csrf
    ...
    @endif
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="skill1" value="{{$data->skill1}}"  placeholder="skill1" name="skill1">
    ...
    @endif
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="skill2" value="{{$data->skill2}}"  placeholder="skill2" name="skill2">
    ...
    @endif
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="skill3" value="{{$data->skill3}}"  placeholder="skill3" name="skill3">
