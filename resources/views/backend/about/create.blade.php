...
<div class="container">
    ...
    @endif
      ...
      <div class="form-group">
        ...
        <input type="link" class="form-control" id="link1" placeholder="link1" name="link1">
        @if ($errors->has('link1'))
    ...
    @endif
      ...
      <div class="form-group">
        ...
        <input type="link" class="form-control" id="link2"   placeholder="link2" name="link2">
        @if ($errors->has('link2'))
    ...
    @endif
      ...
      <div class="form-group">
        ...
        <input type="link" class="form-control" id="link3"  placeholder="link3" name="link3">
        @if ($errors->has('link3'))
    ...
    @endif
      ...
      <div class="form-group">
        ...
        <input type="link" class="form-control" id="link4"  placeholder="link4" name="link4">
        @if ($errors->has('link4'))
    ...
    @endif
      ...
      <div class="form-group">
        ...
        <input type="link" class="form-control" id="link5"  placeholder="link5" name="link5">
        @if ($errors->has('link5'))
